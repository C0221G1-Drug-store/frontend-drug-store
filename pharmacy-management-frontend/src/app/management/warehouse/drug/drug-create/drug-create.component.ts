...
export class DrugCreateComponent implements OnInit {
  ...
  drugName: new FormControl('', [Validators.required, Validators.maxLength(25)]),
    drugIngredient: new FormControl('', [Validators.required, Validators.maxLength(50)]),
    ...
    retailProfitRate: new FormControl('', [Validators.required, Validators.min(0), Validators.pattern(/^\d$/)]),
